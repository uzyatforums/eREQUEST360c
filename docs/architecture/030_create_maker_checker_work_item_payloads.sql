...
/*==============================================================
Migration : 030_create_maker_checker_work_item_payloads.sql
...
BEGIN
    ...
    (
        ...
        /* Friendly display value shown in approval screens */
        entity_name             VARCHAR(200) NULL,

        /* JSON before the proposed change */
        before_payload          NVARCHAR(MAX) NULL,

        /* JSON after the proposed change */
